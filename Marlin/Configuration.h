...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (220 / 2)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT (220 / 2)    // Y point for Z homing when homing all axes (G28).
#endif
